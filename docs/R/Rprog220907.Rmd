---
title: 'StatData1: forelæsning d. 7/9-2022'
...
Datasættet `antibio` beskrevet på dagens forelæsningsslides (7/9-2022) indeholder målinger af mængden af organisk materiale (`org`) i gødning fra 36 kvier, som er inddelt i seks grupper (`type`). Grupperne angiver hvilken type antibiotikum, som har været tilsat til kviernes foder. Gruppen `type = Control` angiver, at der ikke har været tilsat antibiotikum til foderet.
