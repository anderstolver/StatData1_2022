---
title: 'StatData1: forel221031 (første version)'
...
R-programmet fra 19/9-2022 viser, hvordan man fitter og aflæser estimater fra modellen, samt hvordan man konstruerer et konfidensinterval for et punkt på regressionslinjen.
...
Der findes en detaljeret analyse af dette eksempel i R-programmet fra 5/10-2022. Selvom den matematiske fortolkning af modellen her (hvor både respons og forklarene variable log-transformeres) er lidt mere kompleks, så giver eksemplet et godt indblik i fleksibiliteten af klassen af multiple lineære regressionsmodeller.
