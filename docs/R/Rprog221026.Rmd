...
Eksemplet blev første gang diskuteret ved forelæsningen d. 24/10-2022 på Statistisk Dataanalyse 1
...
For en 2x2 tabel laver `chisq.test` som default en kontinuitetskorrektion. Hvis vi ikke vil have det, skal vi bruge optionen `correct=FALSE`. Ved forelæsningerne snakker vi kun om versionen uden kontinuitetskorrektion (-se dog slide 44-45 fra 26/10-2022).
