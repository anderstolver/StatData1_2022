...
Dette eksempel har været benyttet ved forelæsningen d. 10/10-2022. Formålet med eksemplet er at illustrere
...
På den sidste del af forelæsningsslides til 10/10-2022 regnes på et datasæt, hvor de husdyrvidenskabstuderende er fjernet. Her genfittes den additive model for tosidet ANOVA (dvs. modellen uden vekselvirkning) alene baseret på de resterende data (dvs. uden HV studerende).
