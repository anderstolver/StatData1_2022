...
* Målinger af **afstand mellem to punkter** indsamlet på baggrund af studerende på StatData1 i 2022 (formål var at *ramme* en afstand på 8 cm).
...
Vi indlæser datasættet indsamlet ved forelæsningen d. 5/9-2022
...
```{r}
my_data <- read.table("../data/gaet8_2022.txt", header = F)
head(my_data)
...
**Fortolkning:** På baggrund af stikprøven fås et 95 % - konfidensinterval på (6.96; 8.34) cm. Vores vurdering er, at dette interval med 95 %  sandsynlighed vil omfatte den sande (men ukendte) værdi af middelværdien i hele populationen. Specielt kan man ikke på baggrund af stikprøven udelukke, at de studerende på StatData1 i gennemsnit har angivet afstanden til at være 8.0 cm. 
...
Vi laver et histogram og et QQ-plot som vi lærte ved forelæsningen d. 12/9-2022.
