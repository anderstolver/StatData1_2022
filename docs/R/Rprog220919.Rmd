...
Her vises hvordan man kan estimere parametrene (dvs. finde *punktestimater*) i en ensidet variansanalysemodel (ANOVA). Vi regner på datasættet `antibio` der bl.a. blev diskuteret på slides og R program til forelæsningen d. 7/9-2022 (-se også s. 53 og 114 i lærebogen).
